...
const Settings = () => {
  ...
  useEffect(() => {
    const fetch = async () => {
      const res = await axios.get(
        "https://highline-cars-backend.onrender.com/api/v1/user/get-user-info",
        { headers }
      );
      setProfile(res.data);
  ...
  const handleName = async () => {
    const res = await axios.put(
      "https://highline-cars-backend.onrender.com/api/v1/user/update-username",
      uName,
      { headers }
    );
  ...
  const handleSubmit = async () => {
    ...
    const res = await axios.put(
      "https://highline-cars-backend.onrender.com/api/v1/user/update-password",
      uPassword,
      { headers }
    );
    alert(res.data.message);
